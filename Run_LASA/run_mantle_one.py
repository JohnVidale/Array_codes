...
def run_mantle_one(fig_index = 1, eq_num = '1', start_time = 0, wind_len = 100, ref_phase = 'PKiKP',
    ...
    #%% Import functions
    os.chdir('/Users/vidale/Documents/GitHub/Array_codes/Process')
    ...
    slowT_hi       =  slow_limit
    # slow_delta     =  0.005
    NS = True  # True for N-S co=ords, False for R-T
    ...
    #%% -- 1D stack
    # if do_5 == True:
    # pro5stack1d(ARRAY = ARRAY, eq_num = eq_num, plot_scale_fac = 0.05,
    ...
    if do_7a == True:
        pro7_singlet(eq_num = eq_num, wig_scale_fac = wig_scale_fac,
                    ...
                    wiggly_plots = wiggly_plots, log_plot = log_plot, log_plot_range = log_plot_range, fig_index = fig_index,
