...
#run_each(event_no =  7)
#run_each(event_no =  8)
#run_each(event_no = 30)
#run_each(event_no = 31)
#run_each(event_no = 32)
#run_each(event_no = 33)
#run_each(event_no = 34)
#run_each(event_no = 35)
#run_each(event_no = 36)
#run_each(event_no = 37)
...
#run_each(event_no = 44)
#run_each(event_no = 45)
#run_each(event_no = 46)
#run_each(event_no = 4)
#run_each(event_no = 5)
#run_each(event_no = 47)
#run_each(event_no = 48)
...
run_each(event_no = 83)

#  DUPES NOT YET PROCESSED AND NAMED
#run_each(event_no = 56)
#run_each(event_no = 62)
#run_each(event_no = 78)
#run_each(event_no = 82)