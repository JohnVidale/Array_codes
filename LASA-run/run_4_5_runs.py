...
#			dphase = 'PcP', dphase2 = 'PKKP', dphase3 = 'PP', dphase4 = 'S',
#			min_dist = 61.6, max_dist = 62.3, ref_loc = 0)
...
#%% Look at pair of 2D stack results
...
#pro7dec(eq_file1 = eq_file1, eq_file2 = eq_file2, decimate_fac = decimate_fac)

##%% Look at time shift with slowness slices
...
#%% Treatments of individual events
...
#%% Do 1D stack
pro5stack(ARRAY = ARRAY, eq_file = eq_file1, plot_scale_fac = 0.05, slowR_lo = -0.04, slowR_hi = 0.1, slow_delta = 0.001,
			start_buff = start_buff, end_buff = end_buff,
			envelope = 1, plot_dyn_range = 50,
			norm = 1, global_norm_plot = 1, color_plot = 1, fig_index = 301)

#pro5stack(ARRAY = ARRAY, eq_file = eq_file2, plot_scale_fac = 0.05, slowR_lo = -0.04, slowR_hi = 0.1, slow_delta = 0.001,
#			start_buff = start_buff, end_buff = end_buff,
#			envelope = 1, plot_dyn_range = 50,
#			norm = 1, global_norm_plot = 1, color_plot = 1, fig_index = 301)

#%% Look at 2D stack results for individual events
...
#			fig_index = 301, plot_dyn_range = 50, snaptime = snaptime, snaps=1)
#
#pro7plotstack(eq_file = eq_file2, plot_scale_fac = 0.05,
#			slowR_lo = slowR_lo, slowR_hi = slowR_hi, slowT_lo = slowT_lo, slowT_hi = slowT_hi, slow_delta = slow_delta,
#			start_buff = start_buff, end_buff = end_buff,
#			fig_index = 401, plot_dyn_range = 100, snaptime = snaptime, snaps=1)