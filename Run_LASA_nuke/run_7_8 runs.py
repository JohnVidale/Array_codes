...
# convolution only set up for Amchitka events 7 & 8
do_2a = False
do_2b = False
...
nR_plots  = 3     # number of plots along the radial axis, makes (2 x nR_plots - 1) total
...
if do_3a == True:
    pro3singlet(ARRAY = ARRAY, stat_corr = stat_corr, eq_file = eq_file,
                max_taper_length = max_taper_length, simple_taper = simple_taper,
                rel_time = 0, start_buff = start_buff, end_buff = end_buff,
...
#%%  -- 2D stack
if do_5a == True:
    pro5stack2d(eq_file = eq_file, slowR_lo = slowR_lo, slowR_hi = slowR_hi, slowT_lo = slowT_lo,
