...
def pro3bin(eq_num, stat_corr = 1, corr_threshold = 0, rel_time = 1, norm = 1,
            ...
            alt_statics = 0, statics_file = 'nothing', ARRAY = 0, JST = 0, ref_loc = False, ref_rad = 0.4,
...
#    corr_threshold = 0.7  # minimum correlation in measuring shift to use station
    ...
    skip_binning       = False
    if skip_binning:
        print('Option set to skip binning!')
        os.system('say "Option set to skip binning!"')
...
#%% Plot binned traces
    if plot_binned_traces and not skip_binning == True:
#%% -- Re-find station lat-lon
