...
#%% Get saved event info, also used to name files
    ...
    df = pd.read_excel('/Users/ruoyan/Documents/Research/IC/EvLocs/ICevents.full.xlsx', 
                         sheet_name='events_loc_pure')
    lines1 = search_df(df,'INDEX',str(eq_num1),partial_match=True)
    lines2 = search_df(df,'INDEX',str(eq_num2),partial_match=True)
    
#            ids.append(split_line[0])  ignore label for now
    time1 = lines1.TIME1.iloc[0]
    time2 = lines2.TIME1.iloc[0]
    ...
    year1        = time1[0:4]
    year2        = time2[0:4]
    ev_lat1      = float(lines1.LAT1)
    ev_lat2      = float(lines2.LAT1)
    ev_lon1      = float(lines1.LON1)
    ev_lon2      = float(lines2.LON1)
    ev_depth1    = float(lines1.DEP1)
    ev_depth2    = float(lines2.DEP1)
    ...
    if stat_corr == 1 or stat_corr == 2 or stat_corr == 3:  # load static terms
        ...
        if ARRAY == 0:
            if stat_corr == 1: # standard set
                sta_file = '/Users/ruoyan/Documents/Research/IC_codes_JV/Files/sta_statics_hinet.txt'
            elif stat_corr == 2: # custom set made for SSI to Hi-Net PKiKP
                sta_file = '/Users/ruoyan/Documents/Research/IC_codes_JV/Files/SSI_HiNet_statics.txt'
            elif stat_corr == 3: # custom set made for Kawa PKiKP for Hi-NetP
                sta_file = '/Users/ruoyan/Documents/Research/IC_codes_JV/Files/Kawa_HiNet_statics.txt'

        elif ARRAY == 1:
            sta_file = '/Users/ruoyan/Documents/Research/IC_codes_JV/Files/sta_statics_LASA.txt'
        elif ARRAY == 2:
            sta_file = '/Users/ruoyan/Documents/Research/IC_codes_JV/Files/sta_statics_ch.txt'
        elif ARRAY == 5 or ARRAY == 99:
            sta_file = '/Users/ruoyan/Documents/Research/IC_codes_JV/Files/sta_statics_YKA.txt'
        elif ARRAY == 6:
            sta_file = '/Users/ruoyan/Documents/Research/IC_codes_JV/Files/sta_statics_ILAR.txt'
        else:
        ...
        if ARRAY == 0: # Hinet set
            sta_file = '/Users/ruoyan/Documents/Research/IC_codes_JV/Files/sta_hinet.txt'
        elif ARRAY == 1: #         LASA set
            sta_file = '/Users/ruoyan/Documents/Research/IC_codes_JV/Files/sta_LASA.txt'
        elif ARRAY == 2: #         LASA set
            sta_file = '/Users/ruoyan/Documents/Research/IC_codes_JV/Files/sta_ch.txt'
        elif ARRAY == 3: #         NORSAR set
            sta_file = '/Users/ruoyan/Documents/Research/IC_codes_JV/Files/sta_NORSAR.txt'
        elif ARRAY == 4: #         Warramunga set
            sta_file = '/Users/ruoyan/Documents/Research/IC_codes_JV/Files/sta_AU_WR.txt'
        elif ARRAY == 5 or ARRAY == 99: #         Yellowknife set
            sta_file = '/Users/ruoyan/Documents/Research/IC_codes_JV/Files/sta_CN_YK.txt'
        elif ARRAY == 6: #         Yellowknife set
            sta_file = '/Users/ruoyan/Documents/Research/IC_codes_JV/Files/sta_ILAR.txt'
        elif ARRAY == 7: #         Yellowknife set
            sta_file = '/Users/ruoyan/Documents/Research/IC_codes_JV/Files/sta_global.txt'
        with open(sta_file, 'r') as file:
            lines = file.readlines()
...
#%% Load waveforms and decimate to 10 sps
    ...
    if ARRAY == 0:
        ...
        fname1     = '/Users/ruoyan/Documents/Research/IC/Mseed/YKA/' + mseed_name1 + '.mseed'
        fname2     = '/Users/ruoyan/Documents/Research/IC/Mseed/YKA/' + mseed_name2 + '.mseed'
    elif ARRAY == 6:
        fname1     = '/Users/ruoyan/Documents/Research/IC/Mseed/ILAR/' + mseed_name1 + '.mseed'
        fname2     = '/Users/ruoyan/Documents/Research/IC/Mseed/ILAR/' + mseed_name2 + '.mseed'
    elif ARRAY == 7:
        fname1     = '/Users/ruoyan/Documents/Research/IC/Mseed/Global/' + mseed_name1 + '.mseed'
        fname2     = '/Users/ruoyan/Documents/Research/IC/Mseed/Global/' + mseed_name2 + '.mseed'
    elif ARRAY == 99: # compare two versions of files
        fname1     = '/Users/ruoyan/Documents/Research/IC/Mseed/YKA/'  + mseed_name1 + '.mseed'
        fname2     = '/Users/ruoyan/Documents/Research/IC/Mseed/YKA2/' + mseed_name2 + '.mseed'
...
#%%  Check station is there for both events and impose SNR threshold
            ...
            if ((tr1.stats.network  == tr2.stats.network) and
                ...
                if apply_SNR == False:
                    ...
                    if (eq_num1 == 724 or eq_num2 == 724) and (st_name == 'YKB1' or st_name == 'YKR5'):
                        doit = False
                    if (eq_num1 == 731 or eq_num2 == 747) and (st_name == 'YKR1' or st_name == 'YKR2'):
                        doit = False
    ...
    #plt.show()
    if no_plots == False:
        os.chdir('/Users/ruoyan/Documents/Research/IC/Plots_hold')
...
#%%  Save processed files
    ...
    if cnt1 == cnt2 and cnt1 != 0:
        fname1 = '/Users/ruoyan/Documents/Research/IC/Pro_Files/HD' + date_label1 + 'sel.mseed'
        fname2 = '/Users/ruoyan/Documents/Research/IC/Pro_Files/HD' + date_label2 + 'sel.mseed'
