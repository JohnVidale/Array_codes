...
#            ids.append(split_line[0])  ignore label for now
    t           = UTCDateTime(lines.TIME1.iloc[0])
    date_label  = lines.TIME1.iloc[0][0:10]
    ev_lat      = float(      lines.LAT1)
    ev_lon      = float(      lines.LON1)
...
#%% Get location file
    if ARRAY == 0: # Hinet set
        ...
        sta_file = '/Users/ruoyan/Documents/GitHub/Array_codes/Files/sta_CN_YK.txt'
