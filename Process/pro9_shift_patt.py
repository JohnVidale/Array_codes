...
rr = np.linspace(min_lat,   90, int(tsteps))           # steps in lat from min_lat to 90°
theta = np.linspace(0, 2.*np.pi, int((360/dlon) + 1))  # array for longitude
...
#%% Differentiate to compute time shift
