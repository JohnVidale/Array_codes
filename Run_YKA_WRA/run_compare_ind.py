...
# Y_shift of -0.00 means too noisty to evaluate
    if   repeater == 'P01':
        eq_num1 = 701; eq_num2 = 726; do_global = False; do_ILAR = False; do_YKA =  True; tshift = -5.77; shift_both =  2.50; Y_shift =  0.00 ; shift_bothY =  0.0
    elif repeater == 'P02':
        eq_num1 = 701; eq_num2 = 753; do_global = False; do_ILAR = False; do_YKA =  True; tshift = -5.00; shift_both =  2.40; Y_shift = -0.0  ; shift_bothY =  0.0
    elif repeater == 'P03':
        eq_num1 = 702; eq_num2 = 708; do_global = False; do_ILAR = False; do_YKA =  True; tshift = -8.05; shift_both =  2.50; Y_shift = -0.0  ; shift_bothY =  0.0
    elif repeater == 'P04':
        eq_num1 = 702; eq_num2 = 723; do_global = False; do_ILAR = False; do_YKA =  True; tshift = -6.84; shift_both =  2.50; Y_shift =  0.07 ; shift_bothY =  0.0
    elif repeater == 'P05':
        eq_num1 = 702; eq_num2 = 739; do_global = False; do_ILAR = False; do_YKA =  True; tshift = -4.78; shift_both =  2.50; Y_shift = -0.0  ; shift_bothY =  0.0
    elif repeater == 'P06':
        eq_num1 = 702; eq_num2 = 757; do_global = False; do_ILAR = False; do_YKA =  True; tshift = -4.99; shift_both =  2.50; Y_shift =  0.01 ; shift_bothY =  0.0
    elif repeater == 'P07':
        eq_num1 = 703; eq_num2 = 721; do_global =  True; do_ILAR = False; do_YKA =  True; tshift =  0.00; shift_both = -2.20; Y_shift =  0.00 ; shift_bothY =  0.0
    elif repeater == 'P08':
        eq_num1 = 704; eq_num2 = 706; do_global =  True; do_ILAR = False; do_YKA =  True; tshift = -5.35; shift_both =  5.90; Y_shift =  0.00 ; shift_bothY =  0.0
    elif repeater == 'P09':
        eq_num1 = 704; eq_num2 = 713; do_global =  True; do_ILAR = False; do_YKA =  True; tshift = -3.43; shift_both =  5.80; Y_shift =  0.00 ; shift_bothY =  0.0
    elif repeater == 'P10':
        eq_num1 = 705; eq_num2 = 711; do_global =  True; do_ILAR = False; do_YKA =  True; tshift =  0.04; shift_both = -2.00; Y_shift =  0.00 ; shift_bothY =  0.0
    elif repeater == 'P11':
        eq_num1 = 705; eq_num2 = 729; do_global =  True; do_ILAR = False; do_YKA =  True; tshift = -3.86; shift_both = -2.41; Y_shift = -0.012; shift_bothY =  0.0
    elif repeater == 'P12':
        eq_num1 = 706; eq_num2 = 713; do_global =  True; do_ILAR = False; do_YKA =  True; tshift =  1.95; shift_both =  0.40; Y_shift =  0.00 ; shift_bothY =  0.0
    elif repeater == 'P13':
        eq_num1 = 707; eq_num2 = 756; do_global =  True; do_ILAR = False; do_YKA =  True; tshift =  1.70; shift_both = -1.50; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P14':
        eq_num1 = 709; eq_num2 = 730; do_global =  True; do_ILAR = False; do_YKA =  True; tshift =  2.25; shift_both = -1.80; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P15':
        eq_num1 = 709; eq_num2 = 744; do_global =  True; do_ILAR = False; do_YKA =  True; tshift = -2.54; shift_both =  0.10; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P16':
        ...
        eq_num1 = 710; eq_num2 = 728; do_global =  True; do_ILAR = False; do_YKA =  True; tshift = -0.60; shift_both = -3.40; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P20':
        eq_num1 = 711; eq_num2 = 729; do_global =  True; do_ILAR = False; do_YKA =  True; tshift = -3.88; shift_both = -2.50; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P21':
        eq_num1 = 712; eq_num2 = 718; do_global =  True; do_ILAR = False; do_YKA =  True; tshift =  0.35; shift_both = -2.60; Y_shift = -0.013; shift_bothY =  0.0
    elif repeater == 'P22': # too different
        eq_num1 = 714; eq_num2 = 741; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift = -2.90; shift_both =  1.80; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P23': # too different
        eq_num1 = 714; eq_num2 = 748; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =  1.95; shift_both =  1.80; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P24':
        ...
        eq_num1 = 719; eq_num2 = 754; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =  0.03; shift_both = -0.10; Y_shift =  0.0  ; shift_bothY = -1.7
    elif repeater == 'P28':
        eq_num1 = 720; eq_num2 = 736; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift = -3.95; shift_both = -0.15; Y_shift =  0.0  ; shift_bothY = -2.0
    elif repeater == 'P29':
        ...
        eq_num1 = 724; eq_num2 = 746; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =  0.75; shift_both = -1.64; Y_shift =  0.0  ; shift_bothY =  0.0
        ...
        eq_num1 = 730; eq_num2 = 744; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift = -4.82; shift_both =  2.10; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P37':
        eq_num1 = 731; eq_num2 = 747; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift = -1.41; shift_both = -2.41; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P38':  # big changes only in YKA
        eq_num1 = 732; eq_num2 = 750; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =  0.60; shift_both = -2.27; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P39':  # some surprising global shifts
        eq_num1 = 733; eq_num2 = 745; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift = -2.13; shift_both = -1.62; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P40':
        eq_num1 = 734; eq_num2 = 742; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =  7.70; shift_both = -5.88; Y_shift =  0.002; shift_bothY =  0.0
    elif repeater == 'P41':
        eq_num1 = 735; eq_num2 = 751; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =  2.58; shift_both = -1.85; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P42':
...
#%% 2nd set of repeating pairs
        ...
        eq_num1 = 712; eq_num2 = 848; do_global =  True; do_ILAR = False; do_YKA =  True; tshift =  -4.15; shift_both = -0.50; Y_shift = -0.013; shift_bothY =  0.0
    elif repeater == 'P51':
        eq_num1 = 718; eq_num2 = 848; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =  -4.50; shift_both = -0.30; Y_shift =  0.000; shift_bothY =  0.0
    elif repeater == 'P52':
        eq_num1 = 734; eq_num2 = 848; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =   1.10; shift_both = -6.00; Y_shift = -0.029; shift_bothY =  0.0
    elif repeater == 'P53':
        eq_num1 = 742; eq_num2 = 848; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =  -6.60; shift_both =  1.80; Y_shift = -0.033; shift_bothY =  0.0
    elif repeater == 'P54':
        eq_num1 = 704; eq_num2 = 827; do_global =  True; do_ILAR = False; do_YKA =  True; tshift = -11.30; shift_both =  7.50; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P55':
        eq_num1 = 706; eq_num2 = 827; do_global =  True; do_ILAR = False; do_YKA =  True; tshift =  -5.92; shift_both =  2.50; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P56':
        eq_num1 = 713; eq_num2 = 827; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =  -7.86; shift_both =  4.30; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P57':
        ...
        eq_num1 = 809; eq_num2 = 756; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =   0.04; shift_both =  2.30; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P79':
        ...
        eq_num1 = 801; eq_num2 = 752; do_global =  True; do_ILAR = False; do_YKA =  True; tshift =   0.80; shift_both =  1.00; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P86':
        eq_num1 = 804; eq_num2 = 847; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =  -1.74; shift_both =  0.00; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P87':
        eq_num1 = 820; eq_num2 = 835; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =  -0.22; shift_both = -1.00; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P88':
        eq_num1 = 819; eq_num2 = 840; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =   2.88; shift_both = -1.60; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P89':
        ...
        eq_num1 = 813; eq_num2 = 844; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =   0.24; shift_both = -2.00; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P93':
        ...
        eq_num1 = 714; eq_num2 = 832; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =   0.99; shift_both =  2.00; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P97':
        eq_num1 = 806; eq_num2 = 818; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =  -9.42; shift_both = -0.50; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P98':
        ...
        eq_num1 = 712; eq_num2 = 742; do_global =  True; do_ILAR = False; do_YKA =  True; tshift =   2.46; shift_both = -0.50; Y_shift =  0.010; shift_bothY =  0.0
    elif repeater == 'P103':
        eq_num1 = 712; eq_num2 = 734; do_global =  True; do_ILAR = False; do_YKA =  True; tshift =  -5.23; shift_both = -0.60; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P104':
        eq_num1 = 718; eq_num2 = 734; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =  -5.60; shift_both = -0.20; Y_shift =  0.030; shift_bothY =  0.0
    elif repeater == 'P105':
...
#%% 3rd set of repeating pairs
        ...
        eq_num1 = 737; eq_num2 = 858; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =   1.90; shift_both =  0.00; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P116':
        eq_num1 = 852; eq_num2 = 858; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =   1.40; shift_both = -2.00; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P117':
        ...
        eq_num1 = 853; eq_num2 = 861; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =  -5.20; shift_both =  1.00; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P122':
        eq_num1 = 712; eq_num2 = 854; do_global =  True; do_ILAR = False; do_YKA =  True; tshift =  -2.10; shift_both =  0.00; Y_shift = -0.010; shift_bothY =  0.0
    elif repeater == 'P123':
        eq_num1 = 718; eq_num2 = 854; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =  -2.45; shift_both =  0.00; Y_shift =  0.000; shift_bothY =  0.0
    elif repeater == 'P124':
        eq_num1 = 734; eq_num2 = 854; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =   3.11; shift_both = -7.00; Y_shift =  0.008; shift_bothY =  0.0
    elif repeater == 'P125':
        eq_num1 = 742; eq_num2 = 854; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =  -4.55; shift_both =  1.00; Y_shift = -0.030; shift_bothY =  0.0
    elif repeater == 'P126':
        eq_num1 = 848; eq_num2 = 854; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =   2.06; shift_both = -7.00; Y_shift = -0.010; shift_bothY =  0.0
    elif repeater == 'P127':
        eq_num1 = 712; eq_num2 = 859; do_global =  True; do_ILAR = False; do_YKA =  True; tshift =  -3.11; shift_both = -1.00; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P128':
        eq_num1 = 718; eq_num2 = 859; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =  -3.44; shift_both =  0.00; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P129':
        ...
        eq_num1 = 854; eq_num2 = 859; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =  -1.00; shift_both = -3.00; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P133':
        eq_num1 = 709; eq_num2 = 855; do_global =  True; do_ILAR = False; do_YKA =  True; tshift =  -0.64; shift_both = -1.00; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P134':
        eq_num1 = 730; eq_num2 = 855; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =  -2.92; shift_both =  2.00; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P135':
        eq_num1 = 744; eq_num2 = 855; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =   1.93; shift_both = -3.00; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P136':
        eq_num1 = 709; eq_num2 = 856; do_global =  True; do_ILAR = False; do_YKA =  True; tshift =  -2.05; shift_both =  0.00; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P137':
        eq_num1 = 730; eq_num2 = 856; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =  -4.30; shift_both =  2.50; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P138':
        ...
        eq_num1 = 811; eq_num2 = 857; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =   1.23; shift_both =  0.00; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P142':
        eq_num1 = 822; eq_num2 = 857; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =   0.50; shift_both =  0.00; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P143':
        eq_num1 = 754; eq_num2 = 857; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =   1.17; shift_both =  0.00; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P144':
        eq_num1 = 802; eq_num2 = 860; do_global =  True; do_ILAR = False; do_YKA =  True; tshift =  -6.30; shift_both =  0.00; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P145':
        ...
        eq_num1 = 702; eq_num2 = 862; do_global = False; do_ILAR = False; do_YKA =  True; tshift =  -5.30; shift_both =  3.00; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P149':
        eq_num1 = 708; eq_num2 = 862; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =   2.76; shift_both = -5.00; Y_shift =  0.0  ; shift_bothY =  0.0
    elif repeater == 'P150':
        ...
        eq_num1 = 845; eq_num2 = 845; do_global =  True; do_ILAR =  True; do_YKA =  True; tshift =   0.00; shift_both =  0.00; Y_shift =  0.0  ; shift_bothY =  0.0
    else:
