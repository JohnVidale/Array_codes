...
# PKiKP runs YKA
# BAD run_individual_little(eq_num = 528, dphase = 'PKiKP', start_buff_stack = -20, end_buff_stack = 30, start_beam_stack = 10, end_beam_stack = 11, beam_width = 0.04, beam_step = 0.0025, freq_min = 1, freq_max = 3, fig_index = 100, stat_corr = 0)
