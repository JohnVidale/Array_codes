...
sta_file = '/Users/vidale/Documents/GitHub/Array_codes/Run_YKA_WRA/map_repeaters_full.txt'
...
for ii in station_index:
    ...
    comp_ev1[ii]   = float(split_line[1])
    comp_lat[ii]   = float(split_line[2])
    comp_lon[ii]   = float(split_line[3])
    # print(line)
    # print(lines[ii])
