...
# P run
for ii in range(559,560):
    eq_num = ii

    run_individual_little(eq_num = eq_num, dphase = 'P', start_buff_stack = -50, end_buff_stack = 200, start_beam_stack = 0,   end_beam_stack = 100, beam_width = 0.03, beam_offset = 0.05, beam_step = 0.0025, zerophase = False, freq_min = 0.1, freq_max = 10, fig_index = 400, stat_corr = 0, beam_stack_rad = 0.02)
    run_individual_little(eq_num = eq_num, dphase = 'P', start_buff_stack = -50, end_buff_stack = 200, start_beam_stack = 0, end_beam_stack = 100, beam_width = 0.03, beam_offset = 0.05, beam_step = 0.0025, zerophase = False,  freq_min = 1, freq_max = 3, fig_index = 100, stat_corr = 0, beam_stack_rad = 0.02)
    run_individual_little(eq_num = eq_num, dphase = 'P', start_buff_stack = -50, end_buff_stack = 200, start_beam_stack = 0, end_beam_stack = 100, beam_width = 0.03, beam_offset = 0.05, beam_step = 0.0025, zerophase = False,  freq_min = 2, freq_max = 4, fig_index = 200, stat_corr = 0, beam_stack_rad = 0.02)
    run_individual_little(eq_num = eq_num, dphase = 'P', start_buff_stack = -50, end_buff_stack = 200, start_beam_stack = 0, end_beam_stack = 100, beam_width = 0.03, beam_offset = 0.05, beam_step = 0.0025, zerophase = False,  freq_min = 3, freq_max = 5, fig_index = 300, stat_corr = 0, beam_stack_rad = 0.02)
...
# run_individual_little(eq_num = 412, dphase = 'PKiKP', start_buff_stack = -10, end_buff_stack = 40, start_beam_stack = -0.5, end_beam_stack = 1, beam_width = 0.02, beam_step = 0.001, beam_offset = 0.0, freq_min = 3, freq_max = 5, stat_corr = 0)
