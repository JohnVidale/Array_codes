...
def run_individual_df(eq_num = 401, start_buff = 980, end_buff = 1180,
    precursor_shift  = -1000, signal_dur     = -1000,
    start_buff_stack =   -30, end_buff_stack =    40,
    start_beam_stack =     0, end_beam_stack =     0, ARRAY = 5,
    beam_width = 0.04, beam_step = 0.005, beam_offset = 0.00,
    zerophase = True, freq_min = 1, freq_max = 3, slow_delta = 0.0025,
    min_dist = 0, max_dist = 180, dphase  = 'PKiKP', JST = False, R_slow_plot = 0.017, T_slow_plot = 0,
