...
wind_buff = 40                                  # buffer before time window of analysis
...
# start_buff_stack = -70.0
# end_buff_stack = 50.0
# start_beam_stack =  -40.0
# end_beam_stack =  20.0
...
no_tdiff_plot = True  # also to speed plots of only amplitude, only applies to auto_slice
log_plot      = True
tdiff_clip   =  0.15
wig_scale_fac = 0.5
tdiff_scale_fac = 1
...
if do_3 == True:
    pro3pair(ARRAY = ARRAY, eq_num1 = eq_num1, eq_num2 = eq_num2, skip_SNR = skip_SNR,
                ...
                dphase = ref_phase, dphase2 = 'PKIKP', dphase3 = 'PKiKP', dphase4 = 'pPKIKP',
