...
def run_individual(eq_num = 1, start_buff = 980, end_buff = 1180,
    ...
    beam_width = 0.025, beam_step = 0.0005, beam_offset = 0.02, freq_min = 1, freq_max = 3, slow_delta = 0.0025,
    min_dist = 0, max_dist = 180, dphase  = 'PKiKP', JST = True, R_slow_plot = 0.015, T_slow_plot = 0.00,
