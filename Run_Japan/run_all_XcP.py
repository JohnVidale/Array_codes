...
# 101
# run_individual(eq_num = 101, dphase = 'PcP'  , start_beam_stack =    2, end_beam_stack =    7, R_slow_plot = 0.013, T_slow_plot = 0.000, fig_index = 100, stat_corr = 1, apply_SNR = True)
...
# 107
# run_individual(eq_num = 107, dphase = 'PcP'  , start_beam_stack = -0.5, end_beam_stack =    2, R_slow_plot = 0.013, T_slow_plot = 0.000, fig_index = 100, stat_corr = 1, apply_SNR = True)
...
# 109
# run_individual(eq_num = 109, dphase = 'PcP'  , start_beam_stack =    0, end_beam_stack =    2, R_slow_plot = 0.013, T_slow_plot = 0.000, fig_index = 100, stat_corr = 1, apply_SNR = True)
# run_individual(eq_num = 109, dphase = 'ScP'  , start_beam_stack = -1.5, end_beam_stack =  1.5, R_slow_plot = 0.014, T_slow_plot = 0.000, fig_index = 200, stat_corr = 1, apply_SNR = True)
...
# 110
# run_individual(eq_num = 110, dphase = 'PcP'  , start_beam_stack =  0.5, end_beam_stack =  2.5, R_slow_plot = 0.013, T_slow_plot = 0.000, fig_index = 100, stat_corr = 1, apply_SNR = True)
...
# 114
# run_individual(eq_num = 114, dphase = 'PcP'  , start_beam_stack =    2, end_beam_stack =    8, R_slow_plot = 0.013, T_slow_plot = 0.000, fig_index = 100, stat_corr = 1, apply_SNR = True)
