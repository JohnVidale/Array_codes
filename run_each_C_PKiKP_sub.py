...
def run_each_C_PKiKP_sub(start_buff = 980, end_buff = 1180, event_no = 35, min_dist = 0,
			  max_dist = 180, freq_min = 1, freq_max = 3, slow_delta = 0.001,
			  dphase  = 'PKiKP', start_beam = 0, end_beam = 0, ref_loc = 0, ref_rad = 1, ref_lat = 0, ref_lon = 0):
...
#
	pro3singlet(ARRAY = ARRAY, stat_corr = stat_corr, eq_file = eq_file, simple_taper = simple_taper,
				...
				ref_loc = ref_loc, ref_rad = ref_rad, ref_lat = ref_lat, ref_lon = ref_lon, fig_index = 102, JST = 0)
