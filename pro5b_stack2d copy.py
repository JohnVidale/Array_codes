					...
					for slowT_i in range(slowT_n):  # loop over transverse slownesses
						...
						if stack_option == 0:
							for it in range(stack_nt):  # check points one at a time
								...
								if it_in >= 0 and it_in < nt - 1: # data in seismogram?
						...
						if stack_option == 1:
							...
							if nshift <= 0:
								...
								nbeg2 = nshift
								nend2 = stack_nt
#							print('indx slowR slowT ' + str(indx) + ' ' + str(slowR_i) + ' ' + str(slowT_i) +
#								 ' b1 e1  b2 e2 ' + str(nbeg1) + ' ' + str(nend1) + '  ' + str(nbeg2)+ ' ' + str(nend2) +
#								 ' slow11 slow12 ' + str(stack[0].data[0]) + ' ' + str(stack[1].data[0]) +
#								 ' slow21 slow22 ' + str(stack[slowT_n + 0].data[0]) + ' ' + str(stack[slowT_n +  1].data[0]))
