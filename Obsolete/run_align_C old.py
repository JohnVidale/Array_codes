...
def run_get_shift_C(start_buff = -50, end_buff = 200, event_no = 1, min_dist = 0,
...
#%%  Parameters - basic
    ...
    ref_rad = 5 # radius of stations around ref_loc chosen
    ref_lat = 38
    ref_lon = 104.5
...
#%%  pro3singlet -- selects data for statics
    pro3singlet(ARRAY = ARRAY, stat_corr = 1, fine_stats = 0, eq_file = eq_file, simple_taper = 1,
...
#%%  pro4statics -- measures statics
    pro4statics(eq_file, use_ref_trace = 0, ref_trace = 'N.SUY',
        dphase = dphase, dphase2 = dphase2, dphase3 = dphase3, dphase4 = dphase4,
        start_beam = start_beam, end_beam = end_beam, plot_scale_fac = 0.05,
...
#%%  pro3singlet -- selects data
    ...
    #     eq_file = eq_file, simple_taper = simple_taper,
...
#%%  pro6stacked_singlet -- summed beams over 2D stacks
    ...
    #     event_no = event_no, start_beam = start_beam, end_beam = end_beam)
