...
def pro4statics(eq_file, use_ref_trace = 0, ref_trace = 'nothing',
    ...
    print('pro4_get_shifts_Hinet is starting')
...
#    fname     = 'HD' + date_label + '.mseed'
    ...
    if len(tr_ref.data) == 0:
        print('Reference trace empty, will not work!')
        sys(exit)
    ...
    print('        Ref time ' + str(t) + ' start_corr_win end_corr_win max_time_shift ' + str(start_corr_win) + '  ' + str(end_corr_win) + '  ' + str(max_time_shift) + '  ')
