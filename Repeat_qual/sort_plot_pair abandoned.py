...
#%% Import functions
    ...
    print(colored('Running pro3', 'cyan'))
...
#            ids.append(split_line[0])  ignore label for now
    ...
    year_label1  = split_line1[1][0:4]
    year_label2  = split_line2[1][0:4]
...
#%% Get station location file
    if stat_corr == 1 or stat_corr == 2 or stat_corr == 3:  # load static terms
        ...
        sta_file = '/Users/vidale/Documents/GitHub/Array_codes/Files/sta_statics_13.txt'
        ...
        sta_file = '/Users/vidale/Documents/GitHub/Array_codes/Files/sta_13.txt'
        with open(sta_file, 'r') as file:
            lines = file.readlines()
...
#%% Load waveforms and decimate to 10 sps
    ...
    fname1     = '/Users/vidale/Documents/GitHub/Array_codes/Repeat_qual/' + mseed_name1 + '.mseed'
    fname2     = '/Users/vidale/Documents/GitHub/Array_codes/Repeat_qual/' + mseed_name2 + '.mseed'
    st1=read(fname1)
    st2=read(fname2)
